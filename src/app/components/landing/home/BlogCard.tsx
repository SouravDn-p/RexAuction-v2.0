...
const BlogCard: React.FC = () => {
    ...
    const blogImages = [
        ...
        'https://images.unsplash.com/photo-1499750310107-5fef28a66643?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60',
        'https://cdn.logojoy.com/wp-content/uploads/20250313151628/Blog-name-ideas-for-all-blogs.jpg',
    ];
    ...
    return (
        <div className="p-4 sm:p-10 min-h-[70vh] flex ">
            <style>
                {`
                    @keyframes fadeInUp {
                        from {
            ...
            <div
                className={`flex gap-4 sm:gap-6 flex-col rounded-xl md:flex-row items-center  justify-between p-4 sm:p-12 max-w-5xl mx-auto transition-all duration-300 animate-fadeInUp ${
                    isDarkMode
                        ? 'bg-gray-900 text-white'
                        : 'bg-zinc-100 backdrop-blur-3xl text-gray-800'
                }`}
            >
                ...
                <div className="md:w-1/2 mb-4 sm:mb-6 md:mb-0">
                    ...
                    >
                        Join Our <span className="text-purple-500 font-bold">Blog </span>Community And Stay Informed Today
                    </h2>
                    <p
