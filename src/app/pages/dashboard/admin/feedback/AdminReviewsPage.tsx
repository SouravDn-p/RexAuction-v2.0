...
import { Award, ChevronRight, MessageSquare, Star, Users } from "lucide-react";
import { useEffect, useState } from "react";
import { useTheme } from "../../../../../hooks/useTheme";
import { FilterButton } from "../../../../components/ui/customs/FilterButton";
import { StatCard } from "../../../../components/ui/customs/StatCard";

// Define the interface for individual feedback objects
interface Feedback {
  _id: string;
  userName: string;
  role: "buyer" | "seller";
...
// Mock data typed with the Feedback interface
const MOCK_FEEDBACKS: Feedback[] = [
  {
    ...
    role: "buyer",
    userRating: 5,
    userFeedback: "The purchasing process was incredibly smooth. The platform provided all the tracking details I needed, and the item arrived exactly as described!",
  ...
  },
  {
    ...
    role: "seller",
    userRating: 5,
    userFeedback: "As a seller, I love the intuitive dashboard. Payouts are timely, and communicating with customers is completely seamless. Highly recommended!",
  ...
  },
  {
    ...
    role: "buyer",
    userRating: 4,
    userFeedback: "Great customer support! I had a minor issue with my promo code, but the team resolved it within minutes. Will definitely shop here again.",
  ...
  },
  {
    ...
    role: "seller",
    userRating: 4,
    userFeedback: "Listing items is incredibly fast. The seller fee structure is fair compared to alternatives, though I would love to see more bulk-editing tools.",
    image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&h=150&q=80",
    date: "2026-04-19T18:45:00Z"
  }
];
...
const AdminReviewsPage = () => {
  ...
  // Simulate loading effect and populate mock data
  useEffect(() => {
  ...
  const filteredFeedbacks =
    selectedRole === "all"
      ? feedbacks
      : feedbacks.filter(
          (feedback) => feedback.role === selectedRole
        );
  ...
  return (
    ...
    >
      <div className="mx-auto">
        ...
        <div
          className={`relative max-w-7xl mx-auto overflow-hidden rounded-2xl mb-16 p-8 md:p-12 transition-all duration-700 transform ${
                    ...
                    <span
                      className={`inline-flex items-center px-3 py-1  rounded-full text-xs font-medium ${
                        feedback.role === "seller"
                          ? `bg-purple-100 text-purple-800  ${isDarkMode ? 'bg-purple-900/30 text-zinc-200' : ''}`
                          : `bg-blue-100 text-blue-800  ${isDarkMode ? 'bg-blue-900/30 text-purple-400' : ''}`
                      }`}
                    >
