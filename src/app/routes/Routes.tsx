...
import CookiePolicyPage from "../pages/landing/legal/CookiePolicyPage";
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "feedback", element: <FeedbackDisplayPage /> },
  ...
  },
  {
    ...
    children: [
      ...
      { path: "payments", element: <BuyerWalletPage /> },
      { path: "wallet", element: <Navigate to="/buyer/payments" replace /> },
      ...
      { path: "bidHistory", element: <Navigate to="/buyer/status" replace /> },
      { path: "chat", element: <Chat /> },
      { path: "settings", element: <SettingsLayout />, children: settingsChildren },
    ],
  },
